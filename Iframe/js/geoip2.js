...
var geoip2 = (function() {
    ...
    return (
        (t.prototype.fillInObject = function(e) {
            for (
                var t = "country" === this.type ? n.country : n.city, r = 0; r < t.length; r++
            )
        ...
        (t.prototype.getGeoIPResult = function() {
            ...
            var r,
                ...
                this.type +
                "/me?",
                c = { referrer: location.protocol + "//" + location.hostname };
            if (!this.alreadyRan) {
                for (r in ((this.alreadyRan = 1), c))
                    c.hasOwnProperty(r) &&
                    c[r] &&
                    (i += r + "=" + encodeURIComponent(c[r]) + "&");
                ...
                s.open("GET", i, !0),
                    (s.onload = function() {
                        if (void 0 === s.status || 200 === s.status)
                            ...
                            var e,
                                t = s.hasOwnProperty("contentType") ?
                                s.contentType :
