/*!@license Copyright 2013, Heinrich Goebl, License: MIT, see https://github.com/hgoebl/mobile-detect.js*/ !(function(a, b) {
    a(function() {
        ...
        function d(a) {
            for (let b in a) i.call(a, b) && (a[b] = new RegExp(a[b], "i"));
        }
        ...
        return (
            ...
            (function() {
                ...
                for (a in k.props)
                    if (i.call(k.props, a)) {
                        for (
                            b = k.props[a], h(b) || (b = [b]), f = b.length, e = 0; e < f;
                            ++e
                        )
                            (c = b[e]),
                            (j = c.indexOf("[VER]")),
            ...
            (g.findMatches = function(a, b) {
                let c = [];
                for (let d in a) i.call(a, d) && a[d].test(b) && c.push(d);
                return c;
            }),
